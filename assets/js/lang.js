...
const Lang = {
    ...
    translations: {
        ...
        'index.part2.title': { no: 'Del 2: JavaScript Oppgaveliste', en: 'Part 2: JavaScript Task Manager' },
        'index.part2.desc': {
            no: 'Bygg en interaktiv oppgaveliste med ren JavaScript. Lær DOM-manipulering, events og localStorage.',
            en: 'Build an interactive task manager with vanilla JavaScript. Learn DOM manipulation, events and localStorage.'
        },
        'index.part2.item1': { no: 'DOM-manipulering', en: 'DOM manipulation' },
        'index.part2.item2': { no: 'Events og interaktivitet', en: 'Events and interactivity' },
        'index.part2.item3': { no: 'Dynamisk innhold', en: 'Dynamic content' },
        'index.part2.item4': { no: 'LocalStorage', en: 'LocalStorage' },
        ...
        // ========== PART 2 ==========
        'part2.title': { no: 'Del 2: JavaScript Oppgaveliste', en: 'Part 2: JavaScript Task Manager' },
        'part2.subtitle': { no: 'Bygg en interaktiv oppgaveliste med ren JavaScript', en: 'Build an interactive task manager with vanilla JavaScript' },
        ...
        'part2.completedMsg': {
            no: 'Gratulerer! Du har bygget en interaktiv oppgaveliste med JavaScript. Du mestrer nå DOM-manipulering, events, og localStorage. Klar for React i Del 3!',
            en: 'Congratulations! You built an interactive task manager with JavaScript. You now master DOM manipulation, events, and localStorage. Ready for React in Part 3!'
        },
        'part2.startPart3': { no: 'Start Del 3 →', en: 'Start Part 3 →' },
        'part2.ex1.title': { no: 'HTML Grunnstruktur', en: 'HTML Structure' },
        'part2.ex1.desc': { no: 'Bygg grunnstrukturen for oppgavelisten med input, knapp og liste.', en: 'Build the basic structure for the task manager with input, button and list.' },
        'part2.ex2.title': { no: 'CSS Styling', en: 'CSS Styling' },
        'part2.ex2.desc': { no: 'Gjør oppgavelisten pen med CSS — bruk flexbox, farger og spacing.', en: 'Make the task list look nice with CSS — use flexbox, colors and spacing.' },
        'part2.ex3.title': { no: 'Legg til oppgaver (JS)', en: 'Add Tasks (JS)' },
        'part2.ex3.desc': { no: 'Bruk JavaScript til å lese input og legge til nye oppgaver i listen.', en: 'Use JavaScript to read input and add new tasks to the list.' },
        'part2.ex4.title': { no: 'Slett oppgaver (JS)', en: 'Delete Tasks (JS)' },
        'part2.ex4.desc': { no: 'Legg til en slett-knapp (×) på hver oppgave som fjerner den fra listen.', en: 'Add a delete button (×) to each task that removes it from the list.' },
        'part2.ex5.title': { no: 'Merk som ferdig (JS)', en: 'Mark as Done (JS)' },
        'part2.ex5.desc': { no: 'Klikk på en oppgave for å markere den som ferdig med gjennomstreking.', en: 'Click on a task to mark it as done with strikethrough.' },
        'part2.ex6.title': { no: 'Oppgaveteller (JS)', en: 'Task Counter (JS)' },
        'part2.ex6.desc': { no: 'Vis en teller som viser antall oppgaver og hvor mange som er fullført.', en: 'Show a counter displaying total tasks and how many are completed.' },
        'part2.ex7.title': { no: 'Filtrering (JS)', en: 'Filtering (JS)' },
        'part2.ex7.desc': { no: 'Legg til filterknapper for å vise alle, aktive eller fullførte oppgaver.', en: 'Add filter buttons to show all, active or completed tasks.' },
        'part2.ex8.title': { no: 'LocalStorage (JS)', en: 'LocalStorage (JS)' },
        'part2.ex8.desc': { no: 'Lagre oppgavene i nettleseren slik at de overlever en sideoppdatering.', en: 'Save tasks in the browser so they survive a page refresh.' },
